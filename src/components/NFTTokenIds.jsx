...
import { FileSearchOutlined, SendOutlined, ShoppingCartOutlined, RightCircleOutlined } from "@ant-design/icons";
...
function NFTTokenIds({inputValue, setInputValue}) {
  const { NFTTokenIds, error, isLoading } = useNFTTokenIds(inputValue);
